...
from Dataloaders_Preprocessing import MoleculeDataset_Invariance_V3
...
def test_translation_invariance(model, data_list, index_to_test, device, plot_positions=False):
    ...
    dataset_not_translated = MoleculeDataset_Invariance_V3(
        Data_List=molecule,
    ...
    dataset_translated = MoleculeDataset_Invariance_V3(
...
def test_rotation_invariance(model, data_list, index_to_test, device, plot_positions=False, error_threshold=1e-4):
    ...
    dataset_not_rotated = MoleculeDataset_Invariance_V3(
        Data_List=molecule,
        Nb_Atoms_Max_In_Molecule=23,
        Return_Energies=True,
        transform=None
    ...
    dataset_rotated = MoleculeDataset_Invariance_V3(
...
def test_permutation_invariance(model, data_list, index_to_test, device, plot_positions=False):
    ...
    dataset_not_permuted = MoleculeDataset_Invariance_V3(
        Data_List=molecule,
        Nb_Atoms_Max_In_Molecule=23,
        Return_Energies=True,
        transform=None
    ...
    dataset_permuted = MoleculeDataset_Invariance_V3(
